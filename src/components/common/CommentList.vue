 ...
 * @LastEditTime: 2019-12-09 15:24:48
 -->
<template>
  <div class="com-list">
    <div class="com-item" v-for="comment in commentList" :key="comment.id">
      <div class="com-wrapper">
        ...
        <div class="com-content">
          <div class="nick-name">
            <strong class="replyer">{{comment.nickName}}</strong>
      ...
      <send-comment
        ...
        :replyee="comment.nickName?comment.nickName:''"
      />
    </div>
    <send-comment v-show="notLastComment" @click.native="commentBoxClick" />
  </div>
</template>
<script>
...
export default {
  ...
  computed: {
    notLastComment() {
      return this.whichBoxShow != this.commentList.length;
    }
  },
  props: ["commentList"],
  components: {
